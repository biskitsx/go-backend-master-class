...
// Source: github.com/biskitsx/go-backend-master-class/db/sqlc (interfaces: Store)
...
func (m *MockStore) TranferTx(arg0 context.Context, arg1 db.TranferTxParams) (db.TranferTxResult, error) {
	m.ctrl.T.Helper()
